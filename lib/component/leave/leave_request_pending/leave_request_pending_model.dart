...
class LeaveRequestPendingModel extends FlutterFlowModel {
  ...
  // Models for CardRequestLeave dynamic component.
  late FlutterFlowDynamicModels<CardRequestLeaveModel> cardRequestLeaveModels;

  /// Initialization and disposal methods.

  void initState(BuildContext context) {
    cardRequestLeaveModels =
        FlutterFlowDynamicModels(() => CardRequestLeaveModel());
  }

  void dispose() {
    listViewPagingController?.dispose();
    cardRequestLeaveModels.dispose();
  }
