...
import 'calendar_request_attendance_pending_model.dart';
export 'calendar_request_attendance_pending_model.dart';

class CalendarRequestAttendancePendingWidget extends StatefulWidget {
  const CalendarRequestAttendancePendingWidget({
    Key? key,
  ...
  @override
  _CalendarRequestAttendancePendingWidgetState createState() =>
      _CalendarRequestAttendancePendingWidgetState();
}

class _CalendarRequestAttendancePendingWidgetState
    extends State<CalendarRequestAttendancePendingWidget> {
  late CalendarRequestAttendancePendingModel _model;
        ...
        itemBuilder: (context, _, requestAttendancePendingIndex) {
          ...
          return Visibility(
            ...
            child: CardAttendanceWidget(
              key: Key(
                  'Keyi1w_${requestAttendancePendingIndex}_of_${_model.listViewPagingController!.itemList!.length}'),
