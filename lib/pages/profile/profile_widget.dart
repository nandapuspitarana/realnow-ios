  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<ApiCallResponse>(
        future: ProductionHrmsGroup.getProfileCall.call(
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  'http://staging-hrms.realco.co.id/images/avatar.png',
                                  width: 100.0,
                                  height: 100.0,
                                  fit: BoxFit.cover,
                                ),
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      '${valueOrDefault<String>(
                                        ProductionHrmsGroup.getProfileCall
                                            .email(
                                              columnGetProfileResponse.jsonBody,
                                            )
                                            .toString(),
                                        'Realco Winta Indonesia',
                                      )}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed('list_request_attendance_pendin');
                      },
                      child: Container(
                    ...
                    if (false)
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed('approval_request_reimbursement');
                          },
                          child: Container(
                            width: double.infinity,
                            height: 60.0,
